...
<ul>
            <li>
                <a href="http://www.facebook.com/infragistics" target="_blank">
                    <img src='http://jp.staging.igniteui.local/14-1/images/samples/popover/facebook.jpg' />
                    <span class="spanText">Facebook</span>
                </a>
            </li>
            <li>
                <a href="http://twitter.com/infragistics" target="_blank">
                    <img src='http://jp.staging.igniteui.local/14-1/images/samples/popover/twitter.jpg' />
                    <span class="spanText">Twitter</span>
                </a>
            </li>         
            <li>
                <a href="http://www.youtube.com/user/infragistics" target="_blank">
                    <img src='http://jp.staging.igniteui.local/14-1/images/samples/popover/youtube.jpg' />
